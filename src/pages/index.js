...
const IndexPage = () => {
  ...
  const injectCustomerPortal = () => {
    ...
    .then(json => {
      ...
      placeholder.setAttribute('data-yotpo-instance-id', '192552')
      ...
      loader.setAttribute('src', 'https://cdn-widgetsrepository.yotpo.com/v1/loader/qkh5rzpFMqKn6r9wrsXjQIRYUOsBxEGxvitr0w4v')
